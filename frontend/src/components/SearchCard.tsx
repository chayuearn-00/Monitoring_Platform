        ...
        <div className="card">
            ...
            <div className="flex w-full place-content-between">
                <div className="flex gap-10 items-center">
                    ...
                    <button className="button flex gap-2 bg-blue-500 font-bold items-center text-foreground">
                        <Image src={Search} alt="Search icon" width={30} height={30}/>
                        search
                    </button>
                </div>
                <button className="button flex gap-3 border font-normal border-gray-300">
